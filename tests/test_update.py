...
class LoopbackGitHub:
    """A 127.0.0.1 stand-in for api.github.com: replays one canned response
    and records the requests it received, so `GitHubReleaseSource` is
    exercised over real HTTP without touching the network."""
